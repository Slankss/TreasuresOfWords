...
class QuizBriefDialog(var activity : FragmentActivity) {
    ...
    fun startLoadingDialog(correctNumber : String,wrongNumber : String,levelUpList : ArrayList<Question>){
        ...
        levelUpWordsListView.adapter = LevelUpWordsAdapter(activity,levelUpList)
